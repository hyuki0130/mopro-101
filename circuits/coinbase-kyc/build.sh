...
bb write_vk \
  -b ./target/zk_coinbase_attestor.json \
  -o ./target/vk \
  --oracle_hash keccak
echo "✅ VK 생성 완료"
echo ""
...
bb write_solidity_verifier \
  -k ./target/vk/vk \
  -o ./contracts/ZkCoinbaseAttestor.sol
VERIFIER_LINES=$(wc -l < ./contracts/ZkCoinbaseAttestor.sol)
...
echo "  - Verifier: ./contracts/ZkCoinbaseAttestor.sol ($VERIFIER_LINES lines)"
echo ""
echo "💡 bb CLI 버전: $BB_VERSION"
