...
import {useMetamask, useLogs} from '../hooks';
...
export const MetamaskScreen: React.FC = () => {
  ...
  // SDK 상태 변화 로깅
  useEffect(() => {
    addLog(`SDK State: connected=${sdkState.connected}, connecting=${sdkState.connecting}, account=${sdkState.account ? 'yes' : 'null'}`);
  }, [sdkState.connected, sdkState.connecting, sdkState.account, addLog]);
  ...
  const getChainName = (id: string | null): string => {
    ...
    return CHAIN_NAMES[id.toLowerCase()] || `Chain ${id}`;
  };
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
        <View style={styles.content}>
          ...
          <Text style={styles.title}>Metamask</Text>
